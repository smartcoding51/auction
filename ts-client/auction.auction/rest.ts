...
export interface AuctionQueryGetSystemInfoResponse {
  SystemInfo?: AuctionSystemInfo;
}
...
export interface AuctionSystemInfo {
  /** @format uint64 */
  auctionId?: string;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/auction/auction/auction
   */
  queryAuctionAll = (
    query?: {
   ...
   * @request GET:/auction/auction/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<AuctionQueryParamsResponse, RpcStatus>({
      path: `/auction/auction/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/auction/auction/system_info
   */
  querySystemInfo = (params: RequestParams = {}) =>
    this.request<AuctionQueryGetSystemInfoResponse, RpcStatus>({
      path: `/auction/auction/system_info`,
      method: "GET",
      format: "json",
      ...params,
    });
