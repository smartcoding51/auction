...
var (
	...
	pattern_Query_SystemInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1}, []string{"auction", "system_info"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Auction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 0, 1, 0, 4, 1, 5, 1}, []string{"auction", "index"}, "", runtime.AssumeColonVerbOpt(true)))
