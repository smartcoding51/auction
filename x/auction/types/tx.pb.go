...
type MsgCreateAuction struct {
	...
	MinBid  string `protobuf:"bytes,4,opt,name=minBid,proto3" json:"minBid,omitempty"`
}
...
func (m *MsgCreateAuction) GetEndAt() string {
	if m != nil {
		return m.EndAt
	}
	return ""
...
func (m *MsgCreateAuction) GetMinBid() string {
	if m != nil {
		return m.MinBid
	}
	return ""
...
var fileDescriptor_042d57b903dda11f = []byte{
	...
	0x50, 0x11, 0x3d, 0x28, 0xad, 0x94, 0xc7, 0x25, 0xe0, 0x5b, 0x9c, 0xee, 0x5c, 0x94, 0x9a, 0x58,
	...
	,
}
...
func (m *MsgCreateAuction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MinBid) > 0 {
		i -= len(m.MinBid)
		copy(dAtA[i:], m.MinBid)
		i = encodeVarintTx(dAtA, i, uint64(len(m.MinBid)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.EndAt) > 0 {
...
func (m *MsgCreateAuction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.MinBid = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
